    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="row mb-2">
                        <div class="col-sm-12">
                        <label> Name</label>
                            <input type="text" wire:model="edit_name" id="edit_name" class="form-control" placeholder="Category Name" autocomplete="off">
            ...
            <button class="btn"  data-dismiss="modal" id="edit_model_close"> No</button>
